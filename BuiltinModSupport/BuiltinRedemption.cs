...
public class BuiltinRedemption : AutoImplementedModSupport
{
    ...
    protected override void GetData(out Dictionary<string, BiomeEntry> miniBiomes, out Dictionary<string, BiomeEntry> biomes)
    {
        miniBiomes = new Dictionary<string, BiomeEntry>
        {
            ...
            {"FowlMorningBiome",    new BiomeEntry{ Title = "Fowl Morning",    SubTitle = "Redemption", TitleColor = Color.LightYellow,   StrokeColor = Color.Black }},
            {"LidenBiome",          new BiomeEntry{ Title = "Liden",           SubTitle = "Redemption", TitleColor = Color.LightGreen,    StrokeColor = Color.Black }},
            {"LidenBiomeAlpha",     new BiomeEntry{ Title = "Liden Alpha",     SubTitle = "Redemption", TitleColor = Color.LightCoral,    StrokeColor = Color.Black }},
            {"LidenBiomeOmega",     new BiomeEntry{ Title = "Liden Omega",     SubTitle = "Redemption", TitleColor = Color.PaleVioletRed, StrokeColor = Color.Black }},
        ...
        biomes = new Dictionary<string, BiomeEntry>
        {
            ...
            {"SoullessBiome",            new BiomeEntry{ Title = "Soulless",             SubTitle = "Redemption", TitleColor = Color.DarkGreen, StrokeColor = Color.Black }},
